...
- auth-failure-ips - list fail attemts to connect
- auth-failure-ips-tail - tail fail attemts to connect
...
- nextcloud-logs-failure - tail 4xx,5xx error logs from next cloud container
